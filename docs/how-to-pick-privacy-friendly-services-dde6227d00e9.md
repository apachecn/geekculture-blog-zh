...
但是我们没有回答具体的替代方案；我们正在研究帮助您选择在线服务的原则。
...
社区驱动的开源项目工作方式不同:社区完全驱动项目。他们公开讨论所有的问题，所有的发展都是公开的。Linux 就是这样一个开源项目的例子。像 Signal 这样的项目仍然很好，但是发布的代码和公司在服务器上实际使用的代码之间可能会有差异。一般来说，社区驱动的开源项目更加透明。(当然，这并不是说非社区驱动的开源项目不可信。)
