# Django 社交认证:使用 GitHub 登录

> 原文：<https://medium.com/geekculture/django-social-authentication-sign-in-with-github-33390db1a388?source=collection_archive---------5----------------------->

## 如何在 Django framework web apps 中使用 GitHub 登录和注册

![](img/7d408655703a9de99317fde42b5afe59.png)
...
在本文中，我将向您展示如何在 Django 应用程序中使用社交认证。当您构建 web 应用程序时，添加 GithHub 身份验证是您可以添加的最常见的功能。它将帮助用户轻松登录您的网站。所以，不浪费任何时间，让我们开始这个项目。
...
LOGOUT_URL = 'logout'
LOGOUT_REDIRECT_URL = 'login'SOCIAL_AUTH_GITHUB_KEY = '############'
...
现在我们只需要做一件事。让我们建立 Github 开发者档案。推荐你看 **18:32** 之后的视频。这里的视频是。
...
*   点击注册新的应用程序
*   添加应用程序名称:测试
*   主页网址: [http://localhost:8000](http://loacalhost:8000)
*   授权回调 URL:[http://localhost:8000/social-auth/complete/github/](http://localhost:8000/social-auth/complete/github/)
*   点击注册申请
*   生成客户端密码。
*   复制客户端 id 和客户端密码并粘贴到此处:
...
现在点击“用 GitHub 登录”按钮。你现在可以走了。

[**GitHub 代码链接**](https://github.com/imrohit007/Github-auth-Django)
